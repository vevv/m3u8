...
VARIANT_PLAYLIST_WITH_SUPPLEMENTAL_CODECS = '''
#EXT-X-STREAM-INF:BANDWIDTH=11133494,AVERAGE-BANDWIDTH=4877022,CODECS="hvc1.2.4.H120.90,mp4a.40.2",SUPPLEMENTAL-CODECS="dvh1.08.03/dv1p,hvc1.2.4.H120.90/cdm4",RESOLUTION=1920x1080,FRAME-RATE=23.976,VIDEO-RANGE=PQ,HDCP-LEVEL=TYPE-1,AUDIO="aac-128k",SUBTITLES="sub-main"
http://example.com/type0.m3u8
'''
